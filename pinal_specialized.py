...
def render_sprint_task_planner():
                                ...
                                for member in members_sorted:
                                    ...
                                    for idx in task_groups[current_priority].index:
                                        ...
                                        if estimate <= members_sprint_capacity[member]:
                                            ...
                                            memberssprint_capacity[member] -= estimate
    ...
    with ai_tab:
        ...
        df["Mismatch"] = df.apply(lambda row: 
            "Mismatch" if (row["Assigned To"] and 
            row["Component"] and expertise_dict.get(row["Assigned To"]) and 
